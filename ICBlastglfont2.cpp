...
bool GLFont::InitFonts()
{
	glEnable(GL_TEXTURE_2D);
	glEnable(GL_BLEND);
	glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);

	//Create our glFont from icblastfonts.glf, using texture 1
	if (!myfont.Create("icblastfonts.glf", 1))
		return false;
}
...
/**	ifstream inP;
	...
	//Open input file
	inP.open(file_name, ios::in | ios::binary);
...
//*******************************************************************
bool GLFont::Create (string file_name, int tex)
{
